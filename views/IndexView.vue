...
<div>
  ...
  <div class="banner-content">
    ...
    <div class="banner-abs">
      <div class="banner-abs-box">
        <div class="banner-abs-title">金融网历史年化收益率</div>
  ...
  <div class="content">
    ...
    <h2 class="public-title"><span>优选产品</span> <a href="javascript:void(0)"  class="public-title-more" @click="goLink('/page/product/list',{ptype:1})">查看更多产品>></a></h2>
    ...
    <h2 class="public-title"><span>散标产品</span> <a href="javascript:void(0)"  class="public-title-more" @click="goLink('/page/product/list',{ptype:2})">查看更多产品>></a></h2>
    <ul class="preferred-select clearfix">
